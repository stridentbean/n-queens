describe("BitwiseBoard", function() {
  ...
  var verifyConflictTypes = function(expectedConflicts, matrix){
    ...
    var board = new BitwiseBoard(matrix);
    console.dir(board);
  ...
  describe("Empty board", function() {
    verifyConflictTypes([''], [0,0,0,0]);
  });

  describe("Board with row conflicts", function() {
    verifyConflictTypes(['row', 'rooks', 'queens'], [0,12,0,0]);
  });

  describe("Board with col conflicts", function() {
    verifyConflictTypes(['col', 'rooks', 'queens'], [8,0,8,0]);
  });

  describe("Board with major diagonal conflicts", function() {
    verifyConflictTypes(['majorDiagonal', 'queens'], [4,2,0,0]);
  });

  describe("Board with minor diagonal conflicts", function() {
    verifyConflictTypes(['minorDiagonal', 'queens'], [2,0,8,0]);
  });
});
